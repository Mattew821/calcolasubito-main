/**
 * Mapping of Italian municipalities to ISTAT codes
 * Generated from comuni_italiani_2020.csv
 * Total: 7904 comuni
 */

export const COMUNI_ISTAT: Record<string, string> = {
  "AGLI�": "A074",
  "AIRASCA": "A109",
  "ALA DI STURA": "A117",
  ...
  "PR�-SAINT-DIDIER": "H042",
  "QUART": "H110",
  "RH�MES-NOTRE-DAME": "H262",
  "RH�MES-SAINT-GEORGES": "H263",
  "ROISAN": "H497",
  ...
  "LAUREGNO": "E481",
  "LUSON": "E764",
  "MAGR� SULLA STRADA DEL VINO": "E829",
  "MALLES VENOSTA": "E862",
  "MAREBBE": "E938",
  "MARLENGO": "E959",
  "MARTELLO": "E981",
...
export function getCodiceCatastale(nomeComune: string): string {
  const nome = nomeComune?.trim().toUpperCase();
  return COMUNI_ISTAT[nome] || 'XXXX';
}
